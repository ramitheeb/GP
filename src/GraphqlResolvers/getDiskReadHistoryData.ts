...
const getDiskHistoryData = async (_, args, context) => {
  ...
  if (endDate - startDate < 2628000000) key = "disk-usage:read:short";
  else if (endDate - startDate < 15770000000) key = "disk-usage:read:medium";
  else if (endDate - startDate < 126100000000) key = "disk-usage:read:long";
  else return;
