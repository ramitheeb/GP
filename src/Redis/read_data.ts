...
const readData = async (client:RedisTimeSeries,key:string,fromTimestamp:number,toTimestamp:number) =>{
    const samples = await client.range(key,new TimestampRange(fromTimestamp,toTimestamp),15,new Aggregation("AVG",86400000));
