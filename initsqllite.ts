...
db.serialize(function () {
  db.run(
    "CREATE TABLE Alerts (id integer primary key autoincrement, type TEXT NOT NULL, start INTEGER, end INTEGER ,metric TEXT NOT NULL ,component TEXT NOT NULL ,rangeName TEXT d,AlertName TEXT NOT NULL)"
  );
  db.run(
